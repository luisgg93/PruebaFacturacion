...
uses ULstClientes, ULogicaNegocio, ULstProductos, UFacturacion,
   ULstFactura;
...
begin
  try
    ...
    ComputerName := MiFichero.ReadString('info','ComputerName','');
    LogicaNegocio.DCOMConnection.ComputerName := ComputerName;

    MiFichero.Free;

    LogicaNegocio.DCOMConnection.Connected := True;
  except on E: Exception do
    ShowMessage('Error: '+E.Message);
  end;

  if( LogicaNegocio.DCOMConnection.Connected)then
  begin
